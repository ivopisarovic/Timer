...
public:
  ...
  int8_t every(unsigned long period, void (*functionPointer)(void*), void* context = 0, int repeatCount = -1); // -1 is infinite
  int8_t after(unsigned long duration, void (*functionPointer)(void*), void* context = 0);
